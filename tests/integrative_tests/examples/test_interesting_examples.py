...
from examples.interesting_examples import adult_example, california_housing_example, kddcup99_example, \
    ...
    prediction_uncertainty_california_example, titanic_example, active_learning_example, anomalies_in_dataset_example
...
class TestInterestingExamples(unittest.TestCase):
    ...
    def test_anomalies_dataset(self):
        anomalies_in_dataset_example.run(fast=True)
